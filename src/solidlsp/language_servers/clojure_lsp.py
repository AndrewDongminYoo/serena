...
class ClojureLSP(SolidLanguageServer):
    ...
    def _runtime_dependencies(cls, version: str) -> RuntimeDependencyCollection:
        clojure_lsp_releases = (
            f"https://github.com/clojure-lsp/clojure-lsp/releases/download/{version}"
        )
    ...
    class DependencyProvider(LanguageServerDependencyProviderSinglePath):
        def _get_or_install_core_dependency(self) -> str:
            ...
            verify_clojure_cli()
            clojure_lsp_version = self._custom_settings.get(
                "clojure_lsp_version", DEFAULT_CLOJURE_LSP_VERSION
            )
            ...
            install_dir = (
                ...
                if clojure_lsp_version == INITIAL_CLOJURE_LSP_VERSION
                    ...
                    self._ls_resources_dir, f"clojure-lsp-{clojure_lsp_version}"
                )
            )
