...
class SomeSassLanguageServer(SolidLanguageServer):
    ...
    class DependencyProvider(LanguageServerDependencyProviderSinglePath):
        def _get_or_install_core_dependency(self) -> str:
            ...
            package_version = self._custom_settings.get(
                "some_sass_version", DEFAULT_PACKAGE_VERSION
            )
        ...
        for item in items:
            ...
            if section == "somesass":
                ...
                if section not in (None, "editor"):
                    log.debug(
                        "workspace/configuration: unknown section %r; responding with empty dict",
                        section,
                    )
                result.append({})
        return result or [{}]
    ...
    def _start_server(self) -> None:
        ...
        ), "Some Sass LSP did not advertise completionProvider"
