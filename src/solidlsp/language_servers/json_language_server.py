...
class JsonLanguageServer(SolidLanguageServer):
    ...
    class DependencyProvider(LanguageServerDependencyProviderSinglePath):
        def _get_or_install_core_dependency(self) -> str:
            ...
            json_language_server_version = self._custom_settings.get(
                "json_language_server_version", DEFAULT_JSON_LANGUAGE_SERVER_VERSION
            )
            ...
            json_executable_path = os.path.join(
                json_ls_dir, "node_modules", ".bin", "vscode-json-languageserver"
            )
            ...
            if not os.path.exists(json_executable_path):
                log.info(
                    f"JSON Language Server executable not found at {json_executable_path}. Installing..."
                )
