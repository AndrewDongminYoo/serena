...
class CheckOnboardingPerformedTool(Tool):
    ...
    def apply(self) -> str:
        ...
        """
        read_memory_tool_available = self.agent.tool_is_exposed(
            ReadMemoryTool.get_name_from_cls()
        )
        perform_onboarding_tool_available = self.agent.tool_is_exposed(
            OnboardingTool.get_name_from_cls()
        )
...
class OnboardingTool(Tool):
    ...
    def apply(self) -> str:
        ...
        """
        write_memory_tool_available = self.agent.tool_is_exposed(
            WriteMemoryTool.get_name_from_cls()
        )
