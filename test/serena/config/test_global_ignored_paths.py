...
def _create_test_project(
    ...
    serena_config = SerenaConfig(
        gui_log_window=False, web_dashboard=False, ignored_paths=global_ignored_paths
    )
    return Project(
...
class TestGlobalIgnoredPaths:
    ...
    def setup_method(self) -> None:
        ...
        (self.project_path / "node_modules" / "pkg" / "index.js").write_text(
            "module.exports = {}"
        )
    ...
    def test_global_ignored_paths_are_applied(self) -> None:
        ...
        assert project.is_ignored_path(
            str(self.project_path / "node_modules" / "pkg" / "index.js")
        )
...
class TestRegisteredProjectGlobalIgnoredPaths:
    ...
    def test_get_project_instance_passes_global_ignored_paths(self) -> None:
        ...
        serena_config = SerenaConfig(
            gui_log_window=False, web_dashboard=False, ignored_paths=["node_modules"]
        )
        ...
        assert project.is_ignored_path(
            str(self.project_path / "node_modules" / "pkg.js")
        )
    ...
    def test_get_project_instance_without_global_ignored_paths(self) -> None:
        ...
        serena_config = SerenaConfig(
            gui_log_window=False, web_dashboard=False, ignored_paths=[]
        )
        project = registered.get_project_instance(serena_config=serena_config)
        assert not project.is_ignored_path(
            str(self.project_path / "node_modules" / "pkg.js")
    ...
    def test_from_project_instance_passes_global_ignored_paths(self) -> None:
        ...
        assert retrieved.is_ignored_path(
            str(self.project_path / "node_modules" / "pkg.js")
        )
