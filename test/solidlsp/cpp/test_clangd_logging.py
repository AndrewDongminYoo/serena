...
class TestClangdLogging:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "I[12:00:00.000] clangd version 22.1.3",
            ),
    ...
    def test_log_record_detection(self, expected: str, line: str) -> None:
        ...
        """
        assert (
            ClangdLanguageServer._determine_log_level(line)
            == logging.getLevelNamesMapping()[expected]
        )
    ...
    def test_log_record_info_payload_without_prefix(self) -> None:
        ...
        assert (
            ClangdLanguageServer._determine_log_level("[/home/user/project/build]")
            == logging.INFO
        )
