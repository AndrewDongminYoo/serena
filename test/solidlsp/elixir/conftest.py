...
def ensure_elixir_test_repo_compiled(repo_path: str) -> None:
    ...
    try:
        print(
            "Installing dependencies and compiling Elixir test repository for optimal Next LS performance..."
        )
        ...
        print(
            "This may indicate slow CI environment - Next LS may still work but with reduced functionality"
        )
        ...
        print(
            "❌ ERROR: 'mix' command not found - Elixir test repository may not be compiled"
        )
