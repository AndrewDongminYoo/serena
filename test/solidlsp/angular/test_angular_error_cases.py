...
class TestAngularInvalidPositionsOnTs:
    ...
    def test_negative_line_number_containing_symbol(
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_negative_character_number_containing_symbol(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_character_beyond_line_length_returns_enclosing_class(
        self, language_server: SolidLanguageServer
    ) -> None:
        ...
        assert isinstance(
            result, dict
        ), f"Expected dict (containing class), got: {result!r}"
        assert (
            result.get("name") == "AppComponent"
        ), f"Expected containing symbol 'AppComponent', got: {result.get('name')!r}"

    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_references_at_negative_line_returns_empty(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_definition_at_negative_position_returns_empty(
        self, language_server: SolidLanguageServer
    ) -> None:
...
class TestAngularInvalidPositionsOnTemplate:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_negative_line_definition_raises(
        self, language_server: SolidLanguageServer
    ) -> None:
        ...
        assert "Debug Failure" in str(exc_info.value) or "Bad line number" in str(
            exc_info.value
        ), f"Unexpected exception message: {exc_info.value}"

    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_character_beyond_line_definition_raises(
        self, language_server: SolidLanguageServer
    ) -> None:
...
class TestAngularNonExistentFiles:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_nonexistent_ts_file_raises(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_nonexistent_html_file_raises(
        self, language_server: SolidLanguageServer
    ) -> None:
...
class TestAngularUndefinedSymbols:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_definition_at_keyword_position_returns_empty(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_references_for_local_const_have_few_callers(
        self, language_server: SolidLanguageServer
    ) -> None:
        ...
        refs = language_server.request_references(
            SERVICE_FILE, sel["line"], sel["character"]
        )
        ...
        assert (
            1 <= len(refs) <= 3
        ), f"defaultName should have 1-3 references, got {len(refs)}: {refs}"
...
class TestAngularEdgeCasePositions:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_containing_symbol_at_file_start_is_none(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_references_at_file_start_returns_empty(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_definition_at_file_start_returns_empty(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_template_position_no_containing_symbol(
        self, language_server: SolidLanguageServer
    ) -> None:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_containing_symbol_inside_class_body_returns_class(
        self, language_server: SolidLanguageServer
    ) -> None:
        ...
        for line in (5, 10):
            ...
            assert isinstance(
                result, dict
            ), f"Line {line}: expected dict, got {result!r}"
            assert (
                result.get("name") == "AppComponent"
            ), f"Line {line}: expected 'AppComponent', got {result.get('name')!r}"

    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_containing_symbol_outside_class_body_is_none(
        self, language_server: SolidLanguageServer
    ) -> None:
...
class TestAngularReferenceEdgeCases:
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_referencing_symbols_at_invalid_position_raises(
        self, language_server: SolidLanguageServer
    ) -> None:
        ...
        if IS_WINDOWS:
            ...
            result = list(
                language_server.request_referencing_symbols(
                    SERVICE_FILE, -1, -1, include_self=False
                )
            )
    ...
    @pytest.mark.parametrize("language_server", [Language.ANGULAR], indirect=True)
    def test_defining_symbol_at_invalid_position_returns_none(
        self, language_server: SolidLanguageServer
    ) -> None:
...
class TestAngularCoreProbe:
    ...
    def _walk(repo_path: str) -> str | None:
        ...
        """
        from solidlsp.language_servers.angular_language_server import (
...
class TestAngularStartupCleanup:
    ...
    def test_companions_cleaned_up_on_initialize_failure(
        ...
        try:
            ...
            assert (
                ls._ts_server is None
            ), "TS companion was not cleared after startup failure"
            assert (
                ls._html_server is None
            ), "HTML companion was not cleared after startup failure"
            ...
            assert (
                not new_children
            ), f"Companion processes leaked after startup failure: {sorted(new_children)}"
        finally:
