...
- restrict the set of allowed tools via the [configuration](./050_configuration.md),
- use a sandboxed environment for running Serena (e.g. by [using Docker](./020_running.md#using-docker)).
